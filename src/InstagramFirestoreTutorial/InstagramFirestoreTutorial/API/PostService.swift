...
struct PostService {
    ...
    static func likePost(post: Post, completion: @escaping(FirestoreCompletion)) {
        ...
        COLLECTION_POSTS.document(post.postId).collection("post-likes")
    ...
    static func unlikePost(post: Post, completion: @escaping(FirestoreCompletion)) {
        ...
        COLLECTION_POSTS.document(post.postId).collection("post-likes")
            .document(uid).delete { _ in
                COLLECTION_USERS.document(uid).collection("user-likes")
                    .document(post.postId).delete(completion: completion)
            }
    }
    ...
    private static func updateUserFeedAfterPost(postId: String) {
        ...
        COLLECTION_FOLLOWERS.document(uid).collection("user-followers").getDocuments { snapshot, _ in
            ...
            documents.forEach { document in
                COLLECTION_USERS.document(document.documentID)
